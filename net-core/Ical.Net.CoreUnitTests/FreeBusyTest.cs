...
namespace Ical.Net.CoreUnitTests
{
    ...
    public class FreeBusyTest
    {
        ...
        public void GetFreeBusyStatus1()
        {
            ...
            CalendarEvent calendarEvent = calendar.Create<CalendarEvent>();
            calendarEvent.Summary = "Test event";
            calendarEvent.Start = new CalDateTime(2010, 10, 1, 8, 0, 0);
            calendarEvent.End = new CalDateTime(2010, 10, 1, 9, 0, 0);

            var freeBusy = calendar.GetFreeBusy(new CalDateTime(2010, 10, 1, 0, 0, 0), new CalDateTime(2010, 10, 7, 11, 59, 59));
