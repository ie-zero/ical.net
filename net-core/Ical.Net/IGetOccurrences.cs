...
namespace Ical.Net
{
    public interface IGetOccurrences
    {
        ...
        HashSet<Occurrence> GetOccurrences(CalDateTime dt);
        ...
        HashSet<Occurrence> GetOccurrences(CalDateTime startTime, CalDateTime endTime);
    ...
    public interface IGetOccurrencesTyped : IGetOccurrences
    {
        ...
        /// <param name="dt">The date for which to return occurrences.</param>
        /// <returns>A list of Periods representing the occurrences of this object.</returns>
        HashSet<Occurrence> GetOccurrences<T>(CalDateTime dt) where T : IRecurringComponent;
        ...
        /// <param name="startTime">The starting date range</param>
        /// <param name="endTime">The ending date range</param>
        HashSet<Occurrence> GetOccurrences<T>(CalDateTime startTime, CalDateTime endTime) where T : IRecurringComponent;
