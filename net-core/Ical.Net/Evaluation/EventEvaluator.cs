...
namespace Ical.Net.Evaluation
{
    public class EventEvaluator : RecurringEvaluator
    {
        ...
        /// <summary>
        /// Evaluates this event to determine the dates and times for which the event occurs. This
        /// method only evaluates events which occur between <paramref name="periodStart"/> and
        /// <paramref name="periodEnd"/>; therefore, if you require a list of events which occur
        /// outside of this range, you must specify a <paramref name="periodStart"/> and <paramref
        /// name="periodEnd"/> which encapsulate the date(s) of interest.
        ///
        /// For events with very complex recurrence rules, this method may be a bottleneck during
        /// processing time, especially when this method in called for a large number of events, in
        /// sequence, or for a very large time span.
        /// </summary>
