...
namespace Ical.Net.Utility
{
    internal static class TextUtil
    {
        ...
        {
            return haystack.IndexOf(needle, stringComparison) >= 0;
        }
        ...
        public static string FoldLines(string text)
        {
        ...
        /// </summary>
        public static TextReader Normalize(string text, SerializationContext context)
        {
            // Replace \r and \n with \r\n.
            text = NormalizeToCrLf.Replace(text, SerializationConstants.LineBreak);
            text = RemoveEmptyLines(UnwrapLines(text));
